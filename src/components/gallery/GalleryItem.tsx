...
export function GalleryItem({ project }: GalleryItemProps) {
    ...
    return (
        <div className="hoverEl gallery-item w-[80dvw] lg:w-[55dvh] aspect-square flex items-center justify-center snap-end select-none origin-bottom overflow-hidden">
            {isVideo() ? (
                <video
                    ref={videoRef}
                    muted
